VERSION 5.00
Begin VB.Form frmMainFrame 
   BackColor       =   &H00000000&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Visual Marbles! - Initializing Game Engine! -"
   ClientHeight    =   7680
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9600
   Icon            =   "frmMainFrame.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   512
...
End
Attribute VB_Name = "frmMainFrame"
...
frmMain.SetFocus
  bFps = False
  Me.Caption = "Visual Marbles! " & "- Created By Michael J. Hardy" & " - Loading Game..."
  LatestHigh = -1
  
  If InitEngine And InitGfx And InitSfx Then
    LoadScores
    LoadSettings
    Me.Caption = "Visual Marbles! " & "- Created By Michael J. Hardy" & " - Trial Edition!"
    DoTitle
  End If
...
Public Function InitEngine() As Boolean
  ...
  Exit Function
ErrH:
  MsgBox "Could not Initialize Game Engine. Try Installing DirectX 9.0 or Reinstalling Visual Marbles.", vbCritical, "Oh, Oh!, A Dang Error!"
  InitEngine = False
End Function
...
tAgain:
  ...
  Do
    ...
    MainFont.DrawText "Copyright © 2006 - 2007 By ® Hightech Studios!", ReturnRECT(128, 480, 640, 512), RGBA(255, 255, 255, tob((T.GetTimeMs / 2000) * 200)), DT_CENTER Or DT_VCENTER
    MainFont.DrawText "View The Read Me.html in the Directory for Help on the Game!", ReturnRECT(128, 450, 640, 480), RGBA(255, 255, 255, tob((T.GetTimeMs / 2000) * 200)), DT_CENTER Or DT_VCENTER
